...
BAND_PATHS = {
    ...
    "tests/test_transport_death_retry.py": "Physical-attempt and actual main-loop consumer regressions share the ledger fixture while distinguishing interactive bounded repeats from managed continuation after upstream observation.",
    ...
    "web/modules/skills.js": "The installed-skills page keeps read-state retention, contextual refresh and lifecycle reconciliation with its existing list owner; no second store or page framework.",
