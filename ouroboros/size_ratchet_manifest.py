...
BAND_PATHS = {
    ...
    "ouroboros/headless.py": "Terminal file custody and recovery seam spans normal copyback, startup recovery, retry and artifact finalization; keep one owner and shrink on the next structural touch.",
