...
BAND_PATHS = {
    ...
    "ouroboros/headless.py": "The headless task-drive owner keeps copyback, terminal artifact custody and one-pass cleanup together; the band records the existing shared publication seam while preserving its recovery rationale.",
