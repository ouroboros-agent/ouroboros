...
BAND_PATHS = {
    ...
    "ouroboros/consolidator.py": "Dialogue consolidation keeps part-to-part account preparation and immediate refusal-bound persistence with its source/cursor owner; local output normalization is shared with llm_local, without another retry manager or store.",
