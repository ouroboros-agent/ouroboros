...
| GET | `/api/tasks/{task_id}/diff` | `gateway.tasks.api_task_diff` — a thin route over `gateway.task_diff.task_diff_payload` (typed diff projection for the Changes screen / task inspector — see below) |
