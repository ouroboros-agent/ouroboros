...
- `ouroboros/tools/registry_core.py` -- Tool registry execution and deterministic guard-order authority
- `ouroboros/tools/registry_guard_process.py` -- Pre/post process coordinator and command-shape guard authority
- `ouroboros/tools/registry_guards.py` -- Access/update/repair plus root/CWD/workspace/git guard authority
- `ouroboros/tools/tool_resolution.py` -- Physical target and dispatch path resolution authority
